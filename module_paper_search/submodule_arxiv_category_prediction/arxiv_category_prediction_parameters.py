"""
submodule_arxiv_category_prediction/arxiv_category_prediction_parameters.py

This file contains all parameters used by the arXiv category prediction submodule.
...
# Model to use for category prediction
...
SYSTEM_PROMPT = """
You are an AI assistant specialized in scientific paper categorization. 
Your task is to analyze a research query and predict the most relevant arXiv categories that best match this research question.

Return a ranked list (2 to 5 items) of the most relevant arXiv categories that best match this research question.
...
- Full enhanced query: {enhanced_query}

The task is to return a ranked list (2 to 5 items) of the most relevant arXiv categories (e.g., 'hep-ph', 'cs.LG', 'quant-ph', etc.) that best match this research question.
